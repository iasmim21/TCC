								...
								<ul>
									...
									<li class="hassubs">	
										...
										<ul>
											...
											<li><a href="categories.html">Imagens</a></li>
											<li><a href="categories.html">Quadros</a></li>
											<li><a href="categories.html">Chaveiros</a></li>
											<li><a href="categories.html">Decoração</a></li>
											<li><a href="categories.html">Acessórios</a></li>
										</ul>
									</li>
				...
				<div class="col">
					...
					<div class="product_grid">
						...
						<div class="product">
							<div class="product_image">
								<div class="efeito_produto">	
									...
									<div class="categoria">
										<a href="decoraçao.html">Decoração</a>
									</div>		
								</div>
							</div>
						...
						<div class="product">
							<div class="product_image">
								<div class="efeito_produto">	
									...
									<div class="categoria">
										<a href="crucifixo.html">Crucifixos</a>
									</div>		
								</div>
							</div>									
						</div>
						...
						<div class="product">
							<div class="product_image">
								<div class="efeito_produto">	
									<img src="images/categorias/dvds.png" alt="">
									<div class="categoria">
										<a href="cds.html">CD's e DVD's</a>
									</div>		
								</div>
							</div>									
						</div>
						...
						<div class="product">
							<div class="product_image">
								<div class="efeito_produto">	
									...
									<div class="categoria">
										<a href="dvds.html">Correntes Folheadas</a>
									</div>		
								</div>
							</div>									
						</div>
				...
				<div class="col">
					<div class="avds_xl_container clearfix">
						...
						<div class="avds_xl_content">
							...
							<div class="avds_text">Saiba quem foi Santo Antônio, sua história, e se inspire com essa e muitas outras histórias</div>
							<div class="avds_link avds_xl_link"><a href="categories.html">Ver mais</a></div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 home-about-left">
							...
							<a href="#" class="primary-btn">Acesse</a>
						</div>
