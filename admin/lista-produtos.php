                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-bordered table-hover produtos">
                                    



                                    <form action="categoria_lista.php" method="post" id="categoria" name="categoria">
                                        <div class="col-12 col-md-3 mb-15">
                                            <select name="ccategoria" id="ccategoria" class="form-control">
                                                <option value="10">Selecione uma categoria</option>
                                    ...
                                    <?php 
                                        ...
                                        while($dado = $query->fetch_array()){
                                            ...
                                            <tr class="linha">
                                                <td><img src="produtos/<?php echo $imagem[0] ?>" width="100" height="100"/></td>
