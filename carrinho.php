		...
		<div class="container">
			...
			<div class="row cart_items_row">
               ...
               ?>
					...
					<?php //para cadastrar no banco quando clicar em finalizar compra

						array_push($_SESSION['dados'],
							 array('idProduto' => $id, 'quantidade' => $qtd,  'codCliente' => $cod )
						); //array push
						...
						echo '<a href="finalizarPedido.php">Finalizar</a>';
			...
			<div class="row row_extra">
				...
				<div class="col-lg-6 offset-lg-2">
					<div class="cart_total">
						<div class="section_title">Finalizar Compra</div>
						...
						<div class="cart_total_container">
							<ul>
								...
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="cart_total_value ml-auto"><?php echo $peso; ?></div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
